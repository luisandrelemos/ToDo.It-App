...
namespace Aplicação_ToDo.IT.Página_Personalizar
{
    public partial class PáginaPersonalizar : Window
    {
        ...
        {
            // Código para mudar para o tema light mode
            ChangeTheme("Temas/LightRED.xaml");

            // Salva a escolha do tema do Utilizador
            CurrentUser.User.Tema = "LightRED";
            SaveUserTheme();
        ...
        {
            // Código para mudar para o tema light mode
            ChangeTheme("Temas/LightPURPLE.xaml");

            // Salva a escolha do tema do Utilizador
            CurrentUser.User.Tema = "LightPURPLE";
            SaveUserTheme();
        ...
        {
            // Código para mudar para o tema light mode
            ChangeTheme("Temas/LightGREEN.xaml");

            // Salva a escolha do tema do Utilizador
            CurrentUser.User.Tema = "LightGREEN";
            SaveUserTheme();
        ...
        {
            // Código para mudar para o tema light mode
            ChangeTheme("Temas/LightYELLOW.xaml");

            // Salva a escolha do tema do Utilizador
            CurrentUser.User.Tema = "LightYELLOW";
            SaveUserTheme();
        ...
        {
            // Código para mudar para o tema light mode
            ChangeTheme("Temas/LightORANGE.xaml");

            // Salva a escolha do tema do Utilizador
            CurrentUser.User.Tema = "LightORANGE";
            SaveUserTheme();
